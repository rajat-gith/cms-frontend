...
export default function Navbar() {
	...
	const handleLogout = () => {
		...
		clearUserProfile(); // will also reset isAuthenticated
			...
			{isAuthenticated && userProfile && (
				<div className="relative">
					<DropdownMenu>
						...
						<DropdownMenuContent
							align="end"
							className="bg-white dark:bg-gray-900 shadow-lg rounded-lg backdrop-blur-md border border-gray-200 dark:border-gray-700 p-2 w-40"
						>
							<DropdownMenuItem

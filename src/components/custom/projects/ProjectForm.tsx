        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    projectType: e.target.value as "individual" | "group",
                  })
                }
                className="w-full p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              >
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  setFormData({
                    ...formData,
                    teamSize: value === "" ? undefined : parseInt(value),
                  });
                }}
                className="w-full p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setFormData({ ...formData, otherLinks: e.target.value })
              }
              className="w-full p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            />
          </div>
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          updateTeamMember(index, "linkedinURL", e.target.value)
                        }
                        className="p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      />
                      <input
                        ...
                        onChange={(e) =>
                          updateTeamMember(index, "twitterURL", e.target.value)
                        }
                        className="p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      />
                    </div>
